      ...
      <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-gray-900 border-b text-sm py-2.5  dark:bg-neutral-950 dark:border-neutral-700">
        <nav className=" mx-auto w-full flex md:grid md:grid-cols-3 md:gap-x-1 basis-full items-center  px-4 sm:px-6 lg:px-8">
            ...
            <ul className='flex items-center justify-center gap-4'>
              {
                navigation.map(nav => {
                  return (
                    <li key={nav.name}>
                      <Link href={nav.href} className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-[1.4rem] font-semibold color-primary  focus:outline-none  dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300" >
          ...
          <div className="flex-1 flex flex-row justify-end items-center gap-1">
            ...
            <button type="button" className="size-[38px] relative inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-white hover:bg-white/10 focus:outline-none focus:bg-white/10 disabled:opacity-50 disabled:pointer-events-none">
